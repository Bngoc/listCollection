/*!
 * Panda Lockers - v1.1.4, 2015-10-09 
...
(function($){
    ...
    window.bizpanda.createLocker = function( $target, data, lockId, mine ) {
        ...
        $.pandalocker.hooks.add( lockId + '.cancel', function( locker, sender, senderName ){
            $(window).resize();
        });
